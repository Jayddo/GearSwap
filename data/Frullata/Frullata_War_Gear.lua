...
function init_gear_sets()
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		...
		back="Shadow Mantle",waist="Flume Belt +1",legs="Sulev. Cuisses +2",feet="Hermes' Sandals"}
	...
	sets.engaged = {ammo="Aurgelmir Orb +1",
		...
		body="Flam. Korazin +2",hands="Flam. Manopolas +1",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back="Cichol's Mantle",waist="Ioskeha Belt",legs="Flamma Dirs +1",feet="Flam. Gambieras +2"}
