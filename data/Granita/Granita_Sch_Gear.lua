...
function user_job_setup()
	...
	gear.nuke_jse_back = { name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Mag.Atk.Bns."+10',}}
    gear.idle_jse_back = { name="Lugh's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Damage taken-5%',}}
...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC, {main="Daybreak",sub="Sors Shield"})
	...
	sets.midcast['Enhancing Magic'] = {
		...
		body="Peda. Gown +1",
        hands="Arbatel Bracers +1",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Perimede Cape",
    ...
    -- Normal melee group
    sets.engaged = {main="Bolelabunga",sub="Genmei Shield",        
    ammo="Homiliary",
    head="Befouled Crown",
    neck="Loricate Torque",
    ear1="Etiolation Earring",
