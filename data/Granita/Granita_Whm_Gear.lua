function user_setup()
	...
	include('Common/WHM_UserSetup_Common.lua')

end

function init_gear_sets()

	include('Common/WHM_Common.lua')
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.MeleeWeapons = {main="Queller Rod",sub="Ammurapi Shield"}
	sets.weapons.DualWeapons = {main="Queller Rod",sub="Bunzi's Rod"}
    ...
    sets.precast.FC = {main="Grioavolr",sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Inyanga Jubbah +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Veneficium Ring",
	...
	sets.midcast.Cure = {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Kaykaus Mitra +1",neck="Clr. Torque +2",ear1="Glorious Earring",
	...
	sets.midcast.Cure.DT = set_combine(sets.midcast.CureSolace,{
	...
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club,sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		...
		waist="Embla Sash",legs="Piety Pantaln. +3",feet="Theo. Duckbills +3"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Theo. Bliaut +2",hands="Theophany Mitts +3",ring1="Kishar Ring",ring2="Balrahn's Ring",
		back="Aurist's Cape +1",waist="Rumination Sash",legs="Th. Pant. +3",feet="Theo. Duckbills +3"}
	...
	sets.idle = {main="Mpaca's Staff",sub="Umbra Strap",ammo="Homiliary",
		head="Inyanga Tiara +2",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Eabani Earring",
		body="Piety Bliaut +3",hands="Inyan. Dastanas +2",ring1="Defending Ring",ring2="Inyanga Ring",
		back="Alaunus's Cape",waist="Fucho-no-obi",legs="Assid. Pants +1",feet="Inyan. Crackows +2"}

	sets.idle.PDT = set_combine(sets.idle,{main="Malignance Pole",sub="Umbra Strap",ammo="Homiliary",
		head="Bunzi's Hat",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Eabani Earring",
		ring1="Defending Ring",
		back="Alaunus's Cape",})
		
	sets.idle.MDT = set_combine(sets.idle,{main="Malignance Pole",sub="Umbra Strap",ammo="Homiliary",
	head="Bunzi's Hat",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Eabani Earring",
	ring1="Defending Ring",
	back="Alaunus's Cape",})
	...
	sets.engaged = {main="Mpaca's Staff",sub="Umbra Strap",ammo="Homiliary",
		head="Inyanga Tiara +2",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Eabani Earring",
		body="Piety Bliaut +3",hands="Inyan. Dastanas +2",ring1="Defending Ring",ring2="Inyanga Ring",
		back="Alaunus's Cape",waist="Fucho-no-obi",legs="Assid. Pants +1",feet="Inyan. Crackows +2"}
