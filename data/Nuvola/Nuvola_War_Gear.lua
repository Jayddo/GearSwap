...
--	state.Weapons:options('NaegBlur','Chango','DualWeapons','Greatsword','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcClub','ProcStaff')
	state.Weapons:options('NaegBlur','DualWeapons')
...
function init_gear_sets()
	...
	sets.defense.PDT = {ammo="Staunch Tathlum +1",
		...
		body="Tartarus Platemail",hands="Sulev. Gauntlets +2",ring1="Defending Ring",ring2="Moonlight Ring",
	...
	sets.engaged.NaegBlur.DT = set_combine(sets.engaged.NaegBlur,{
