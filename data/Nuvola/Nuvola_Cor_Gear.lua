function user_setup()
	...
	include('Common/COR_UserSetup_Common_REG.lua')

end

function init_gear_sets()

	include('Common/COR_Common_REG.lua')
...
function user_job_setup()
	...
	state.Weapons:options('DualSavageWeapons','None')
...
function init_gear_sets()
    ...
    sets.precast.WS.Acc = {
        ...
        back=gear.str_wsd_jse_back,waist="Grunfeld Rope",legs="Carmine Cuisses +1",feet="Lanun Bottes +1"}		
	...
	sets.precast.WS['Savage Blade'] = {ammo=gear.WSbullet,
        head="Meg. Visor +2",neck="Comm. Charm +1",ear1="Moonshade Earring",ear2="Ishvara Earring",
        body="Laksa. Frac +3",hands="Meg. Gloves +2",ring1="Petrov Ring",ring2="Karieyh Ring",
        back=gear.str_wsd_jse_back,waist="Sailfi Belt +1",legs="Meg. Chausses +2",feet="Lanun Bottes +1"}
    ...
    sets.precast.WS['Last Stand'] = {ammo=gear.WSbullet,
        head="Lanun Tricorne +1",neck="Comm. Charm +1",ear1="Moonshade Earring",ear2="Telos Earring",
    ...
    sets.precast.WS['Leaden Salute'] = {ammo=gear.MAbullet,
        ...
        back=gear.magic_wsd_jse_back,waist="Eschan Stone",legs="Nyame Flanchard",feet="Lanun Bottes +1"}
    ...
    sets.midcast.RA = {ammo=gear.RAbullet,
        head="Malignance Chapeau",neck="Comm. Charm +1",ear1="Navarch's Earring",ear2="Telos Earring",
        body="Malignance Tabard",hands="Meg. Gloves +2",ring1="Crepuscular Ring",ring2="Ilabrat Ring",
        back=gear.tp_ranger_jse_back,waist="Eschan Stone",legs="Meg. Chausses +2",feet="Herculean Boots"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        back=gear.tp_jse_back,waist="Carrier's Sash",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
    ...
    sets.idle.PDT = {ammo=gear.RAbullet,
        ...
        body="Malignance Tabard",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Dark Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Meg. Chausses +2",feet="Herculean Boots"}
    ...
    sets.engaged.DW = {
		...
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Petrov Ring",ring2="Rajas Ring",
