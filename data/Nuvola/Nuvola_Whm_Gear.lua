...
function init_gear_sets()
	...
	include('Common/WHM_REG_Common.lua')
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.MeleeWeapons = {main="Kaja Rod",sub="Ammurapi Shield"}
	...
	sets.midcast.MeleeCure = set_combine(sets.midcast.Curaga,{})
	...
	sets.midcast['Enhancing Magic'] = {
		...
		ear2="Mimir Earring",
		body="Telchine Chas.",
		hands="Inyan. Dastanas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Perimede Cape",
		waist="Embla Sash",
