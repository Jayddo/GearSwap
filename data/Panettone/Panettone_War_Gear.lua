...
--	state.Weapons:options('Chango','DualWeapons','Greatsword','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcClub','ProcStaff')
	state.Weapons:options('Naegling')

	gear.da_jse_back = {name="Cichol's Mantle",augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken -10%'}}
	gear.wsd_jse_back = {name="Cichol's Mantle",augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Phys. dmg. taken-8%'}}
...
function init_gear_sets()
    ...
    sets.precast.WS = {
		...
		head="Sakpata's Helm",
		neck="Fotia Gorget",
		ear1="Lugra Earring +1",ear2="Moonshade Earring",
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		...
		body="Sakpata's Breastplate",hands="Sakpata's Gauntlets",ring1="Defending Ring",ring2="Archon Ring",
