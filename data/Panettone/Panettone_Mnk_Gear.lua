function user_setup()
	...
	include('Common/MNK_UserSetup_Common.lua')

end

function init_gear_sets()

	include('Common/MNK_Common.lua')
...
function init_gear_sets()
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		...
		body="Hiza. Haramaki +2",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Warden's Ring",
