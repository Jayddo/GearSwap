...
gear.herculean_nuke_head = { name="Herculean Helm", augments={'Accuracy+19','Weapon skill damage +3%','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}
gear.herculean_nuke_legs = { name="Herculean Trousers", augments={'"Mag.Atk.Bns."+27','VIT+4','Accuracy+16 Attack+16','Mag. Acc.+16 "Mag.Atk.Bns."+16',}}
gear.herculean_wsd_head = { name="Herculean Helm", augments={'Attack+21','Weapon skill damage +3%','STR+8','Accuracy+15',}}
gear.herculean_wsd_legs = { name="Herculean Trousers", augments={'Pet: "Dbl.Atk."+2 Pet: Crit.hit rate +2','Attack+25','Weapon skill damage +6%','Accuracy+16 Attack+16','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}
